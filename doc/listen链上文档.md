...
8. 群主或是群议员踢人
	...
	* 逻辑：
		- 群存在
		- 群没有在等待解散的队列
		- 必须是群主或是固定人数的群议员(目前设置为2)或是过半议员通过才能踢人
		- 被踢的人在群里
		- 群解散后， 这个被踢的人不被奖励（这里逻辑要重新审核）
		- 踢人后，放入群组黑名单
		- 如果被踢的人在议会榜单 那么更新议会
		- 群主不能随意踢人： 一次仅可以踢一个人； 群主踢人有时间间隔要求(在可以踢人的时间段才能踢)， 具体看白皮书
***
9. 要求解散群
...
***
25. 解散群
    * 代码: `fn disband_room(origin, group_id: u64)`
    * 参数: 
        * group_id: 房间号
    * 逻辑
        * 解散投票通过
...
***
26. 群议会拒绝解散群
    * 代码: `fn council_reject_disband(origin, group_id: u64)`
    * 参数: 
        * group_id: 房间号
    * 逻辑:
        * 过半议员同意
        * 群解散投票通过，但是还没到可以解散的时间
***
27. 手动领取群过期红包
    * 代码: `fn return_expired_redpacket(origin, group_id: u64)`
    * 参数: 
        * group_id: 房间号
    * 逻辑:
        * 任何人都可以操作
